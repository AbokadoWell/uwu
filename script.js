...
window.onload = function(){
    ...
    *letra*1 = *letra*.length (Quant. de cada anime com essa letra)*/
    ...
    g = ['<ul><li>given', '</li><li>golden boy', '</li><li>gun frontier</li></ul>']; g1 = g.length;
