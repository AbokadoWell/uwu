...
window.onload = function(){
    ...
    *letra*1 = *letra*.length (Quant. de cada anime com essa letra)*/
    ...
    g = ['<ul><li>gakuen babysitters', '</li><li>given', '</li><li>golden boy', '</li><li>gun frontier</li></ul>']; g1 = g.length;
    ...
    t = ['<ul><li>tari tari', '</li><li>tejina-senpai', '</li><li>to be hero', '</li><li>toki wo kakeru shoujo', '</li><li>tokyo magnitude 8.0', '</li><li>tonari no kaibutsu-kun', '</li><li>tonari no seki-kun', '</li><li>tonari no totoro', '</li><li>tonikaku kawaii</li></ul>']; t1 = t.length;
    u = ['<ul><li>. . .</li></ul>']; u1 = 0;
