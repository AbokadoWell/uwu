...
window.onload = function(){
    ...
    *letra*1 = *letra*.length (Quant. de cada anime com essa letra)*/
    a = ['<ul><li>afro samurai', '</li><li>aho girl', '</li><li>akame ga kill', '</li><li>akashic records', '</li><li>akkun to kanojo', '</li><li>alice to zouroku', '</li><li>angel beats!', '</li><li>anohana', '</li><li>another', '</li><li>ao haru ride', '</li><li>arakawa under the bridge', '</li><li>asobi asobase</li></ul>']; a1 = a.length;
    ...
    j = ['<ul><li>jibaku shounen hanako-kun', '</li><li>just because</li></ul>']; j1 = j.length;
    ...
    m = ['<ul><li>mahou shoujo site', '</li><li>maquia: when the promised flower blooms', '</li><li>mononoke hime', '</li><li>my roommate is a cat</li></ul>']; m1 = m.length;
    ...
    q = ['<ul><li>. . .</li></ul>']; q1 = 0;
    r = ['<ul><li>. . .</li></ul>']; r1 = 0;
    s = ['<ul><li>sakamoto desu ga?', '</li><li>sen to chihiro no kamikakushi', '</li><li>shigatsu wa kimi no uso', '</li><li>shimoneta', '</li><li>suki-tte li na yo', '</li><li>sword art online</li></ul>']; s1 = s.length;
    t = ['<ul><li>tari tari', '</li><li>tejina-senpai', '</li><li>to be hero', '</li><li>toki wo kakeru shoujo', '</li><li>tokyo magnitude 8.0', '</li><li>tonari no kaibutsu-kun', '</li><li>tonari no seki-kun', '</li><li>tonari no totoro', '</li><li>tonikaku kawaii', '</li><li>toradora!', '</li><li>tsurezure children</li></ul>']; t1 = t.length;
    u = ['<ul><li>. . .</li></ul>']; u1 = 0;
    ...
    animes = ['<ul><li>afro samurai', '</li><li>aho girl', '</li><li>akame ga kill', '</li><li>akashic records', '</li><li>akkun to kanojo', '</li><li>alice to zouroku', '</li><li>angel beats!', '</li><li>anohana', '</li><li>another', '</li><li>ao haru ride', '</li><li>arakawa under the bridge', '</li><li>asobi asobase', '</li><li>baccano!', '</li><li>banana fish', '</li><li>barakamon', '</li><li>beastars s1', '</li><li>black★rock shooter', '</li><li>blend-s', '</li><li>blood c', '</li><li>bloom into you', '</li><li>boku dake ga inai machi (erased)', '</li><li>boku wa tomodachi ga sukunai', '</li><li>bunny girl', '</li><li>charlotte', '</li><li>classroom of the elite', '</li><li>corpse party: tortured souls', '</li><li>d-frag!', '</li><li>danshi koukousei no nichijou', '</li><li>deadman wonderland', '</li><li>death note', '</li><li>death parade', '</li><li>devilman crybaby', '</li><li>diabolik lovers', '</li><li>dorohedoro', '</li><li>elfen lied', '</li><li>gakuen babysitters', '</li><li>gekkan shoujo nozaki-kun', '</li><li>given', '</li><li>flying witch', '</li><li>fukumenkei noise', '</li><li>golden boy', '</li><li>gun frontier', '</li><li>hanayamata', '</li><li>handa-kun', '</li><li>hinamatsuri', '</li><li>hitori bocchi no marumaru seikatsu', '</li><li>horimiya', '</li><li>houkago teibou nisshi', '</li><li>hourou musuko', '</li><li>how to keep a mummy', '</li><li>ijiranaide nagatoro-san', '</li><li>inuyashiki', '</li><li>ito junji: collection', '</li><li>jibaku shounen hanako-kun', '</li><li>just because', '</li><li>kaguya sama', '</li><li>kakegurui', '</li><li>keppeki danshi! aoyama-kun', '</li><li>kill me baby', '</li><li>kimetsu no yaiba', '</li><li>kiseijuu (parasyte)', '</li><li>kiss him, not me', '</li><li>koi to uso', '</li><li>kokoro connect', '</li><li>konosuba', '</li><li>kyoukai no kanata', '</li><li>little witch academia', '</li><li>lovely★complex', '</li><li>mahou shoujo site', '</li><li>my roommate is a cat', '</li><li>nanatsu no taizai', '</li><li>naruto classic', '</li><li>nichijou', '</li><li>no.6', '</li><li>noblesse', '</li><li>one punch man', '</li><li>ore monogatari!!', '</li><li>orange', '</li><li>oregairu', '</li><li>osake wa fuufu ni natte kara', '</li><li>oshiete! galko-chan', '</li><li>plastic memories', '</li><li>poputepipikku', '</li><li>sakamoto desu ga?', '</li><li>shigatsu wa kimi no uso', '</li><li>shimoneta', '</li><li>suki-tte li na yo', '</li><li>sword art online', '</li><li>tari tari', '</li><li>tejina-senpai', '</li><li>to be hero', '</li><li>tokyo magnitude 8.0', '</li><li>tonari no kaibutsu-kun', '</li><li>tonari no seki-kun', '</li><li>tonikaku kawaii', '</li><li>toradora!', '</li><li>tsurezure children', '</li><li>violet evergarden', '</li><li>yakusoku no neverland', '</li><li>yuri on ice', '</li><li>zankyou no terror</li></ul>']; //Os animes
