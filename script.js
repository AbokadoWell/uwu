...
window.onload = function(){
    ...
    *letra*1 = *letra*.length (Quant. de cada anime com essa letra)*/
    ...
    p = ['<ul><li>perfect blue', '</li><li>plastic memories', '</li><li>poputepipikku', '</li><li>prison school</li></ul>']; p1 = p.length;
    q = ['<ul><li>. . .</li></ul>']; q1 = 0;
    r = ['<ul><li>. . .</li></ul>']; r1 = 0;
    s = ['<ul><li>sakamoto desu ga?', '</li><li>sen to chihiro no kamikakushi', '</li><li>serial experiments lain', '</li><li>shigatsu wa kimi no uso', '</li><li>shimoneta', '</li><li>suki-tte li na yo', '</li><li>sword art online</li></ul>']; s1 = s.length;
    ...
    w = ['<ul><li>weathering with you', '</li><li>wotakoi</li></ul>']; w1 = w.length;
    x = ['<ul><li>. . .</li></ul>']; x1 = 0;
