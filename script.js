...
window.onload = function(){
    ...
    *letra*1 = *letra*.length (Quant. de cada anime com essa letra)*/
    a = ['<ul><li>afro samurai', '</li><li>aho girl', '</li><li>aiura', '</li><li>akame ga kill', '</li><li>akashic records', '</li><li>akkun to kanojo', '</li><li>alice to zouroku', '</li><li>angel beats!', '</li><li>anohana', '</li><li>another', '</li><li>ao haru ride', '</li><li>arakawa under the bridge', '</li><li>asobi asobase</li></ul>']; a1 = a.length;
