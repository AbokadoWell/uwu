...
window.onload = function(){
    ...
    *letra*1 = *letra*.length (Quant. de cada anime com essa letra)*/
    ...
    m = ['<ul><li>mahou shoujo site', '</li><li>maquia: when the promised flower blooms', '</li><li>mononoke hime', '</li><li>my dress up darling', '</li><li>my roommate is a cat</li></ul>']; m1 = m.length;
